    ...
    class Meta:
        ...
        widgets = {
            ...
            'min_bid': NumberInput(attrs={
                'class': 'form-control', 'min': '1', 'step': '0.05', 'placeholder': 'Starting Bid (Required)'
            }),
...
class BidForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        # Constructor that looks for top_bid and min_bid values needed when validating new bid entered on this form.
        if kwargs:
    ...
    def clean_bid(self):
        """Custom validator to make sure the bid entered is greater than or equal to the listings minimum bid and
